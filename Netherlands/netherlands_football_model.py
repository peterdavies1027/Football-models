...
for year in range(19,23):
    ...
    netherlands_all = pd.concat((netherlands_all, pd.read_csv("https://www.football-data.co.uk/mmz4281/{}{}/N1.csv".format(year, year+1, sort=True))))
...
for i, j in zip(HomeTeam, AwayTeam):
    ...
    matrix = dixon_coles_simulate_match(netherlands_params, i, j, max_goals=10)
