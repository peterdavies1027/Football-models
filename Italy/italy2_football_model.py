...
def champ_match_day(HomeTeam, AwayTeam):
    matrix = dixon_coles_simulate_match(champ_params, HomeTeam, AwayTeam, max_goals=10)
...
for year in range(19,23):
    ...
    italy2_all = pd.concat((italy2_all, pd.read_csv("https://www.football-data.co.uk/mmz4281/{}{}/I2.csv".format(year, year+1, sort=True), encoding = 'unicode escape')))
