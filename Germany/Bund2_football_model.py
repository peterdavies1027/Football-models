...
for year in range(19,23):
    ...
    bund2_all = pd.concat((bund2_all, pd.read_csv("https://www.football-data.co.uk/mmz4281/{}{}/D2.csv".format(year, year+1, sort=True))))
...
#und2_params_YC = solve_parameters_decay_YC(bund2_YC_1720, xi = 0.00325)
