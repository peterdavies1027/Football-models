...
for year in range(18,21):
    ...
    SC_L1_all = pd.concat((SC_L1_all, pd.read_csv("http://www.football-data.co.uk/mmz4281/{}{}/SC2.csv".format(year, year+1, sort=True), encoding = 'unicode escape')))
...
for i, j in zip(HomeTeam, AwayTeam):
    ...
    matrix = dixon_coles_simulate_match(SC_L1_params, i, j, max_goals=5)
    ...
    matrix_YC = dixon_coles_simulate_match(SC_L1_params_YC, i, j, max_goals=10)
