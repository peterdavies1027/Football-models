...
L1_1720 = L1_all[['Date', 'HomeTeam','AwayTeam','FTHG','FTAG', 'FTR', 'time_diff']]

# Rename some columns to sensible names
L1_1720 = L1_1720.rename(columns={'FTHG': 'HomeGoals', 'FTAG': 'AwayGoals'})

# Not interested in anything with na in this dataset
L1_1720 = L1_1720.dropna(how='all')

######

# Same dataset as above however we are interested in yellow cards rather than goals
L1_YC_1720 = L1_all[['HomeTeam', 'AwayTeam', 'HY', 'AY', 'FTR', 'time_diff']]

# Rename some columns so they are of more use
L1_YC_1720 = L1_YC_1720.rename(columns={'HY': 'HomeYellowC', 'AY': 'AwayYellowC'})

# Not interested in anything with na in this dataset
L1_YC_1720 = L1_YC_1720.dropna(how='all')
...
L1_params = solve_parameters_decay(L1_1720, xi = 0.00325)
...
for i, j in zip(HomeTeam, AwayTeam):
    ...
    matrix_YC = dixon_coles_simulate_match(L1_params_YC, i, j, max_goals=10)
