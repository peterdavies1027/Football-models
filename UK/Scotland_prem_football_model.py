...
for year in range(18,21):
    ...
    SC_prem_all = pd.concat((SC_prem_all, pd.read_csv("http://www.football-data.co.uk/mmz4281/{}{}/SC0.csv".format(year, year+1, sort=True), encoding = 'unicode escape')))
...
for i, j in zip(HomeTeam, AwayTeam):
    ...
    matrix = dixon_coles_simulate_match(SC_prem_params, i, j, max_goals=5)
    ...
    matrix_YC = dixon_coles_simulate_match(SC_prem_params_YC, i, j, max_goals=10)
