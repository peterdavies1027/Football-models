...
L2_1820 = pd.DataFrame()
for year in range(18,20):
    L2_1820 = pd.concat((L2_1820, pd.read_csv("http://www.football-data.co.uk/mmz4281/{}{}/E3.csv".format(year, year+1, sort=True))))
L2_1820['Date'] = pd.to_datetime(L2_1820['Date'],  format='%d/%m/%Y')
L2_1820['time_diff'] = (max(L2_1820['Date']) - L2_1820['Date']).dt.days
L2_1820 = L2_1820[['HomeTeam','AwayTeam','FTHG','FTAG', 'FTR', 'time_diff']]
L2_1820 = L2_1820.rename(columns={'FTHG': 'HomeGoals', 'FTAG': 'AwayGoals'})
L2_1820 = L2_1820.dropna(how='all')
...
L2_params = solve_parameters_decay(L2_1820, xi = 0.00325)
